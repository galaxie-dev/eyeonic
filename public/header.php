            ...
            <nav class="header-nav">
                ...
                <?php if(isset($_SESSION['user_id'])): ?>
                           ...
                           <a href="orders.php" class="nav-link">
                            ...
                            <a href="dashboard.php"><div class="user-avatar" onclick="toggleDropdown()" style="width: 40px; height: 40px; border-radius: 50%; background-color: #2563eb; color: white; display: flex; align-items: center; justify-content: center; font-weight: bold; cursor: pointer;">
