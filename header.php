    ...
    <header class="premium-header">
        <div class="header-container">
            ...
            <nav class="header-nav">
                ...
                <a href="public/products.php" class="nav-link">
                    <i class="fas fa-glasses"></i>
                    <span>Shop</span>
                </a>
                <a href="public/wishlist.php" class="nav-link">
                ...
                <?php if(isset($_SESSION['user_id'])): ?>
                           ...
                           <a href="public/orders.php" class="nav-link">
                            ...
                            <a href="public/dashboard.php"><div class="user-avatar" onclick="toggleDropdown()" style="width: 40px; height: 40px; border-radius: 50%; background-color: #2563eb; color: white; display: flex; align-items: center; justify-content: center; font-weight: bold; cursor: pointer;">
