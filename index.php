                ...
                <ul class="splide__list">
                    <li class="splide__slide">                                         
                        ...
                        <div class="hero-content">
                            ...
                            <a href="public/login.php"><button class="btn-shop" type="button">Shop Now</button></a>
                        </div>
                    </li>
                    <li class="splide__slide">                     
                        ...
                        <div class="hero-content">
                            ...
                            <p class="hero-subtitle">From classic designs to modern trends, we have frames to suit every face and style.</p>
                             <a href="public/login.php"><button class="btn-shop" type="button">Browse Collection</button></a>
                        </div>
                    </li>
                       <li class="splide__slide">                     
                        ...
                        <div class="hero-content">
                            ...
                            <p class="hero-subtitle">Limited time offer on selected frames. Don't miss out on these amazing deals!</p>
                             <a href="public/login.php"><button class="btn-shop" type="button">Lets see how you can see</button></a>
                        </div>
                    </li>
                    <li class="splide__slide">                     
                        ...
                        <div class="hero-content">
                            ...
                            <p class="hero-subtitle">Limited time offer on selected frames. Don't miss out on these amazing deals!</p>
                             <a href="public/login.php"><button class="btn-shop" type="button">View Lasting offers</button></a>
                        </div>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-content">
                            ...
                            <div class="product-actions">
                                <a href="public/login.php?id=<?php echo $product['id']; ?>" class="add-to-cart">                                  
                                    Add to Cart
                                </a>
                                <a href="public/login.php?id=<?php echo $product['id']; ?>" class="view-details">                                  
                                    Details
                                </a>
                            </div>
                        </div>
